...
class HandToPaddle:
    ...
    def __capture_image(self):
        while True:
            ...
            if self.flag_img_1_is_ready_to_receive:
            ...
            # self.success = False
            self.flag_img_1_is_ready_to_receive = not (
                self.flag_img_1_is_ready_to_receive)
            self.event_roll.clear()

    def __capture_hand(self):
        while True:
            ...
            if self.flag_img_1_is_ready_to_receive:
                ...
                # img_1 can be accessed thread-safe
                hand, self.img_1 = self.detector.findHands(self.img_1,
                                                           draw=False)
                if hand:
                    _, hand_height = hand[0]["center"]
                    hand_from_center = (hand_height -
